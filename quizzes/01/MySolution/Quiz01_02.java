...
public class Quiz01_02 {
	...
	// the same.
	FnList<Character> val1 =  FnListSUtil.fwork$make(a -> { Consumer<Character> val2 = b -> a.accept(b );  ffcs.accept( val2); });
	return val1; }
    public static void main (String[] args) {
	// HX-2025-10-12:
	// Please write minimal testing code for thirdOrderFun.
	FnList<Character> val3 = thirdOrderFun(k -> { k.accept('B');  k.accept('U'); k.accept('C');  });
	FnListSUtil.System$out$print( val3); System.out.println();  } }
